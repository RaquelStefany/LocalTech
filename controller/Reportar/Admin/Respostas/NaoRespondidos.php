<?php
    ...
    try {
        ...
        $respostas = $conexao->prepare("SELECT cod as Codigo, id_cliente as Cliente, id_tecnico as Tecnico, assunto as Assunto, usuario as Sobre, relatorio as Relatorio, DATE_FORMAT(data, '%d-%M-%Y %H:%i') as Data, resposta as Resposta from report where resposta is null order by id_report desc;");
        $respostas->execute();
        
        if($respostas->RowCount()){
            ...
            echo "<h2 style='text-align: center; color: green;'>Todos os Reports Foram Respondidos</h2>";
        }           
