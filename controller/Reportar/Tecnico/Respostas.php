<?php
    ...
    try {
        ...
        $respostas = $conexao->prepare("SELECT cod as Codigo, assunto as Assunto, usuario as Sobre, relatorio as Relatorio, DATE_FORMAT(data, '%d-%M-%Y %H:%i') as Data, resposta as Resposta from report where id_tecnico = {$_SESSION['id_tecnico']} order by id_report desc");
        $respostas->execute();
