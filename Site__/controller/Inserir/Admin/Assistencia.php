<?php
    ...
    if(!empty($dados['Cadastrar'])){
        ...
        if($lemial > 0){
            ...
            echo "javascript:window.location='login-assistencia.php';</script>";
        }
        ...
        if($pegar_id_assistencia > 0){
            ...
            if($cadastrar_data->rowCount()){
                ...
                $assistencia = $conexao->prepare("INSERT INTO contato (id_assistencia, codificacao, email, telefone, verificacao) VALUES ('" . $_SESSION['id_cadastro'] . "', '" . $codificacao . "', '" . $dados['email'] . "', '" . $dados['telefone'] . "', 'Nao')");
                $assistencia->execute();
