<?php
    ...
    if(!empty($dados['Inserir'])){
        ...
        if($lemial > 0){
            ...
            echo "javascript:window.location='Clientes.php';</script>";
        }
        ...
        if($pegar_id_cliente > 0){
            ...
            if($cadastrar_data->rowCount()){
                ...
                $cliente = $conexao->prepare("INSERT INTO contato (id_cliente, email, telefone, verificacao) VALUES ('" . $_SESSION['id_cadastro'] . "', '" . $dados['email'] . "', '" . $dados['telefone'] . "', 'Nao')");
                $cliente->execute();
