<?php
    ...
    if(!empty($dados['Cadastrar'])){
        ...
        if($lemial > 0){
            ...
            echo "javascript:window.location='login-cliente.php';</script>";
        }
        ...
        if($pegar_id_cliente > 0){
            ...
            if($cadastrar_data->rowCount()){
                ...
                $cliente = $conexao->prepare("INSERT INTO contato (id_cliente, codificacao, email, telefone, verificacao) VALUES ('" . $_SESSION['id_cadastro'] . "', '" . $codificacao . "', '" . $dados['email'] . "', '" . $dados['telefone'] . "', 'Nao')");
                $cliente->execute();
