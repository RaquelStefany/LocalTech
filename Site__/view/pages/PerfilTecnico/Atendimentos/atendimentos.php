...
<head>
    ...
    <title><?php echo $LinhaDados['Nome'] . " " . $LinhaDados['Sobrenome']; ?> - Atendimentos - LocalTech</title>
        ...
        <div class="user-sidebar-container">
            ...
            <div class="user-sidebar-menu">
                <ul>
                    ...
                    <li>
                        <a href="atendimentos.php" class="user-active">
            ...
            <section class="user-section">
                <div class="tabela">
                    <table>
                        ...
                        <tbody>
                            <?php
                                require('../../../../controller/Atendimentos/Tecnico/Dados.php');
                            ?>
                </div>
            </section>
        </main>
