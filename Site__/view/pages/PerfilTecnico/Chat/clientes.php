...
<div class="scrollToTop-btn flex-center">
            ...
            <div class="grid">
                <main class=" main ">
                    <div class="wrapper">
                        <section class="users">
                            <div class="search">
                                <span class="text">Selecione um usuario para começar</span>
                                <input type="text" placeholder="Insira um nome para começar...">
    ...
    <script src="../../../assets/js/chat-tecnico.js"></script>
