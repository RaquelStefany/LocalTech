...
<div class="scrollToTop-btn flex-center">
        ...
        <div class="user-sidebar-container">
            ...
            <div class="user-sidebar-menu">
                <ul>
                    ...
                    <li>
                        <a href="clientes.php" class="user-active">
                        ...
                        <section class="chat-area">
                            <header style="justify-content: space-between; position: inherit; border-radius: 15px 15px 0 0;">
                                <div style="display: flex;">
                                    <img src="../../../assets/images/ImagensPerfil/<?php echo $cli_chat['Imagem']; ?>" alt="">
                                    <div class="details">
                                        <span>Cliente - <?php echo $cli_chat['Nome'] . " " . $cli_chat['Sobrenome']; ?></span>
                                        <p><?php echo $cli_chat['Status']; ?></p>
                                    </div>
                                </div>
                            ...
                            <form method="POST" action="" class="typing-area" autocomplete="off" style="border-radius: 0 0 15px 15px;">
                                <input type="text" name="cliente" value="<?php echo $cli_chat['ID']; ?>" hidden>
                                <input type="text" name="tecnico" value="<?php echo $LinhaDados['ID']; ?>" hidden>
                                <?php

                                    require_once('../../../../controller/Chat/Tecnico/AreaMensagem.php');
                                ...
                                <?php
                                    ...
                                    require_once('../../../../controller/Chat/Tecnico/EnviarMensagem.php');
    ...
    <script src="../../../assets/js/chat-tecnico2.js"></script>
