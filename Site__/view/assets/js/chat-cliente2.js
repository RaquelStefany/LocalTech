...
setInterval(() => {
    ...
    xhr.open("GET", "../../../../controller/Chat/Cliente/PegarChat.php", true);
    xhr.onload = () => {
...
setInterval(() => {
    ...
    xhr2.open("GET", "../../../../controller/Chat/Cliente/VerificarAtendimento.php", true);
    xhr2.onload = () => {
...
setInterval(() => {
    ...
    xhr3.open("GET", "../../../../controller/Chat/Cliente/VerificarMensagem.php", true);
    xhr3.onload = () => {
