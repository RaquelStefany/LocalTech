...
<head>
    ...
    <title>
        Dados - Assistência Técnica - Painel Administrador
    </title>
</head>
    ...
    <div class="container">
        <aside>
            ...
            <div class="sidebar">
                ...
                <a href="../Tecnico/Tecnicos.php" class="active">
                    <span class="material-icons-sharp">
                        manage_accounts
                    </span>
                    <h3>
        ...
        <main style="overflow-x: auto;">
            ...
            <form method="POST">
                ...
                <?php
                    require_once('../../../../controller/Selecionar/Admin/Dados/Assistencias.php');
                ?>
        </main>
    ...
    <script src="../../assets/js/dados-assistencia.js"></script>
    <script>
        AOS.init();
    </script>
