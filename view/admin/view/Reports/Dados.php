...
<head>
    ...
    <title>
        Dados - Reports - Painel Administrador
    </title>
</head>
...
<div class="container">
        ...
        <main>
            ...
            <?php
                require_once('../../../../controller/Reportar/Admin/Respostas/Dados.php');
            ?>
            <form action='Dados.php' method='POST'>
                <?php
                    require_once('../../../../controller/Reportar/Admin/Respostas/Responder.php');
                ?>
                <textarea name="admresposta" rows="4" placeholder="Resposta" autocomplete="off" required style="margin: 10px 10px;
                border: none; background-color: #ededed; border-radius: 4px; color: #333; padding: 14px 10px; width: 100%; resize: none;"></textarea>
                <input class="btntable" type="submit" value="Enviar resposta" name="Resposta"/>
            </form>
        </div>
    </div>
</div>
    ...
    <script src="../../assets/js/dados-report.js"></script>
    <script>
        AOS.init();
    </script>
