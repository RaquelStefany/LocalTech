    ...
    <div class="container">
        ...
        <main>
            ...
            <div class="insights" style="grid-template-columns: repeat(2, 1fr);">
                <a href="Respondidos.php" class="sales" style="display: flex; justify-content: space-evenly; height: 93px; background: aliceblue;">
            ...
            <div class="recent-orders">
                <?php
                    require('../../../../controller/Reportar/Admin/Respostas/Respondidos.php');
                ?>
            </div>
        </main>
