    ...
    <div class="container">
        ...
        <main>
            ...
            <div class="search-field">
                <input id="searchbar" style="width: 100%; background: transparent; text-align: center; font-size: large;" class="search" onkeyup="search_tecnico()" type="text" name="search" placeholder="Procurar Técnico">
            </div>
            <script>
                // JavaScript code
                function search_tecnico() {
