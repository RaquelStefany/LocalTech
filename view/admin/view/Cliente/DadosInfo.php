...
<head>
    ...
    <title>
        Dados - Cliente - Painel Administrador
    </title>
</head>
    ...
    <div class="container">
        ...
        <main style="overflow-x: auto;">
            ...
            <form method="POST">
                ...
                <?php
                    require_once('../../../../controller/Selecionar/Admin/Dados/ClientesInfo.php');
                ?>
        </main>
        ...
        <div class="right">
            ...
            <div class="sales-analytics">
                <h2>
                    ...
                    <button type="submit" name="Remover" class="item offline" style="width: 100%;">                        
                        <div class="icon">
                            <span class="material-icons-sharp">
                                remove
                            </span>
    ...
    <script src="../../assets/js/dados-cliente.js"></script>
    <script>
        AOS.init();
    </script>
