    ...
    <div class="container">
        ...
        <main>
            ...
            <div class="search-field">
                <input id="searchbar" style="width: 100%; background: transparent; text-align: center; font-size: large;" class="search" onkeyup="search_cliente()" type="text" name="search" placeholder="Procurar Cliente">
            </div>
            <script>
                // JavaScript code
            ...
            <form method="POST">
                <?php
                    require_once('../../../../controller/Remover/Admin/Verificacao/Cliente.php');
                    require_once('../../../../controller/Selecionar/Admin/Dados/Selecionar/Cliente.php');
                    require_once('../../../../controller/Atualizar/Admin/Selecionar/Cliente.php');
                ?>
                <div class="recent-orders">
                    ...
                    <table>
                        ...
                        <tbody>
                            <?php
                                require_once('../../../../controller/Selecionar/Admin/Clientes.php');
                            ?>
                        </tbody>
                    </table>
                </div>
                ...
                <div id="demo-modal" class="modal">
                    <div class="modal__conteudo">
                        ...
                        <br>
                        <div class="options">
                            <a href="../../../../controller/Remover/Admin/Cliente.php" id="btnopr">
                                Remover
                            </a>
                            <a href="Clientes.php" id="btnopc">
                                Cancelar
                            </a>
                        </div>
                    </div>
