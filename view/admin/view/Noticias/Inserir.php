...
<head>
    ...
    <title>
        inserir - Postagens - Painel Administrador
    </title>
</head>
    ...
    <div class="container">
        ...
        <main>
            ...
            <div class="div-form">
                ...
                <section class="form">
                    <div class="img-form">
                        <img src="../../assets/img/news-icon.png" id="preview" style="border-radius: 0 !important;">
                    </div>
                    <form method="POST" enctype="multipart/form-data">
                        <?php
                            require_once('../../../../controller/Postagem/Admin/Inserir.php');
                        ?>
                        <h1 hidden>
                        </h1>
                        <fieldset>
                        ...
                        <fieldset class="dadospost">
                            ...
                            <div class="container-form">
                                ...
                                <input type="text" name="autor" placeholder="Digite o Autor da Postagem" required>
                            </div>
                        </fieldset>
                        <br>
                        <fieldset>
                            <div class="container-form">
                                ...
                                <div style="padding: 1% 1% 0%;">
                                    <textarea name="conteudo" id="trumbowyg-editor" cols="30" rows="10" placeholder="Digite o Conteúdo da Postagem" required></textarea>
                                </div>
                            </div>
                        </fieldset>
                        <fieldset style="justify-content: right; display: flex; padding: 0px 10px;">
                            <input type="submit" value="Adicionar Postagem" id="cadastrar" name="Inserir" class="btn-atualizar">
                        </fieldset>
                    </form>
                </section>
