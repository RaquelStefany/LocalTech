    ...
    <div class="container">
        ...
        <main>
            ...
            <div class="search-field">
                <input id="searchbar" style="width: 100%; background: transparent; text-align: center; font-size: large;" class="search" onkeyup="search_atendimento()" type="text" name="search" placeholder="Procurar Atendimento">
            </div>
            <script>
                // JavaScript code
                function search_atendimento() {
