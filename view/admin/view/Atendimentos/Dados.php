...
<head>
    ...
    <title>
        Dados - Atendimentos - Painel Administrador
    </title>
</head>
...
<div class="container">
        ...
        <main>
            ...
            <?php
                require_once('../../../../controller/Atendimentos/Admin/Dados.php');
                //require "../../../../assets/img/images/pngtree-mbe-style-registration-icon-png-image_619969-removebg-preview.png";
            ?>
        </main>
    ...
    <script src="../../assets/js/dados-atendimentos.js"></script>
    <script>
        AOS.init();
    </script>
