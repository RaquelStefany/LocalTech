...
<html lang="pt-BR" dir="ltr">
  <head>
    ...
    <title>Assistências Técnicas - LocalTech</title>
        ...
        <div class="nav-bar">
            ...
            <div class="navigation">
                <div class="nav-items">
                    ...
                    <a class="active" href="../Servicos/servicos.php">
                        Serviços
                    </a>
        ...
        <div class="container flex-center">
            ...
            <div class="content">
                <div class="services-description" style="text-align: center;">
                    <h3>
                        Encontre a assistência técnica mais perto de sua casa
                    </h3>
                    <div class="search-field">
                        <input id="searchbar" class="search" onkeyup="search_assistencia()" type="text" name="search" placeholder="Procurar Assistências">
                ...
                <br>
                <br>
                <ul class="service-list" style="display: grid;">
                    <?php
                        require_once('../../../controller/Selecionar/Assistencias/Assistencias.php');
                    ?>
                </ul>
            </div>
        </div>
