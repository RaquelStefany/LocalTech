            ...
            <div class="content">
                <div class="contact-left">
                    ...
                    <ul class="contact-list">
                        ...
                        <li>
                            ...
                            <span>
                                <a href="malito:localtech.contato@hotmail.com">
                                    localtech.contato@hotmail.com
                                </a>
                            </span>
                        </li>
                        <li>
                ...
                <div class="contact-right">
                    ...
                    <form method="POST" class="contact-form" enctype="multipart/form-data">
                        <?php
                            require('../../../controller/Contato/Enviar.php');
                            require('../../../controller/Mensagens/Mensagem.php');
                        ?>
                        <div class="first-row">
                        ...
                        <div class="third-row">
                            <textarea name="mensagem" rows="7" placeholder="Mensagem" autocomplete="off" required></textarea>
                        </div>
                        <input type="submit" class="btnf" name="enviar" value="Enviar Mensagem">
                    </form>
                </div>
            </div>
        </div>
