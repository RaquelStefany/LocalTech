...
<html lang="pt-BR" dir="ltr">
  <head>
    ...
    <title>Iniciar Sessão - LocalTech</title>
        ...
        <div class="container flex-center">
            ...
            <div class="content">
                <div class="skills-info">
                    <a href="login-cliente.php" class="experience-card">
                    ...
                    <a href="login-tecnico.php" class="experience-card">
                        <div class="upper login">
                            <h3>
                                Técnico
                            </h3>
                    ...
                    <a href="login-assistencia.php" class="experience-card">
                        <div class="upper login">
                            <h3>
                                Assistência Técnica
                            </h3>
