...
<head>
    ...
    <title>Assistência Técnica - Iniciar Sessão - LocalTech</title>
...
<body>
    ...
    <div class="container">
        <div class="forms-container">
            <div class="signin-signup">
                ...
                require_once('../../../controller/Selecionar/Assistencia.php');
            ...
            ?>
                ...
                require_once('../../../controller/Inserir/Assistencia.php');
                require_once('../../../controller/Mensagens/Mensagem.php');
            ...
            ?>
                    <div class="register">
                        ...
                        <div class="input-field">
                            ...
                            <input type="time" name="horaabrir" placeholder="Horário-Abertura*" required />
                        </div>
                        <div class="input-field">
                            <i class="fas fa-solid fa-clock"></i>
                            <input type="time" name="horafechar" placeholder="Horário-Fechamento*" required>
                        </div>
                        <h4>
                    ...
                    <li class="">
                        ...
                        <div class="service-modal flex-center termos">
                            <div class="service-modal-body" id="teste"
                                ...
                                <p>
                                    <b>• 3.1.</b> O cliente deverá informar os dados de forma completa para realizar o
                                    cadastro
                                    no website, não fornecendo qualquer informação falsa, fraudulenta ou que não seja
                                    correspondente aos seus dados.
                                    <br>
                                    <b>• 3.2.</b> É responsabilidade do cliente qualquer erro na escrita ou na
                                    transmissão
                                    errônea dos dados.
                                    <br>
                                    <b>• 3.3.</b> O cliente deverá se comprometer a receber a visita técnica em sua
                                    respectiva
                                    ...
                                    <br>
                                    <b>• 3.5.</b> Cada cliente só poderá efetuar um cadastro, não sendo aceito mais de
                                    uma
                                    conta por CPF.
                                    <br>
                                    <b>• 3.6.</b> Para empresas que desejam se cadastrar, é obrigatório a apresentação
                                    do CNPJ.
                                    <br>
                                    ...
                                    <br>
                                    <b>• 3.8.</b> Não Enviar mensagens nas avaliações e/ou chats que possam ir de
                                    encontro com
                                ...
                                <p>
                                    <b>• 4.1.</b> Não ser possível o início de contato através do chat com algum
                                    cliente,
                                ...
                                <p>
                                    ...
                                    <br>
                                    <b>• 5.1.</b> Todos os técnicos serão submetidos a uma avaliação comprobatória de
                                    seus
                                ...
                                <p>
                                    ...
                                    <br>
                                    <b>• 6.2.</b> Toda imagem, ilustração, obras de arte, HTML, nomes comerciais,
                                    softwares ou
                                    vídeo disponibilizados em nossa plataforma por um dos gerenciadores da página são de
                                    nossa propriedade.
                                    <br>
                                    <b> 6.2.1.</b> Imagens e vídeos são meramente ilustrativas, pois dependendo do
                                    monitor ou
                                    ...
                                    propriedade.
                                    <br>
                                    <b>• 6.4.</b> É vedada a cópia sem autorização de qualquer imagem, vídeo, design,
                                    áudios,
                                    aparência ou descrições de produtos existentes em nossa web página, sob pena de
                                    responder por sanções quem desobedecer.
                                    <br>
                                    <b>• 6.5.</b> Não nos responsabilizamos por links externos que possam vir a aparecer
                                    em
                                    nossa página.
                                    <br>
                                    <b>• 6.6.</b> Nada contido em nossa web página garante o direito a concessão de
                                    licença ou
                                    direito de uso sem o consentimento expresso de um dos gerenciadores da página ou do
                                    proprietário da página.
                                    <br>
                                    <b>• 6.7.</b> O consentimento de cópia ou compartilhamento deve vir por escrito de
                                    forma
                                    clara e expressa.
                                </p>
                                <h4>
                                ...
                                <p>
                                    <b>• 8.1.</b> Fica eleito no canal de postagem da nossa empresa, para dirimir
                                    quaisquer
    ...
    <script src="../../assets/js/logins-ass.js"></script>
