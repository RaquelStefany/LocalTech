<?php
    ...
    require_once('../../../controller/Postagem/Dados.php');

    if(!isset($LinhaPostagem['Titulo'])){
...
<html lang="pt-BR" dir="ltr">
  <head>
    ...
    <title><?php echo $LinhaPostagem['Titulo']; ?> - LocalTech</title>
        ...
        <div class="container flex-center">
            ...
            <div class="content">
                <div class="services-description" style="text-align: center;">
                    <img src="../../assets/images/Postagens/Capas/<?php echo $LinhaPostagem['Capa']; ?>">
                    <br>
                    <br>
                    <h5 class="legenda">
                        Criado por <?php echo $LinhaPostagem['Autor']; ?> <?php echo $data; ?>
                    </h5>
                </div>
                <br>
                <div class="materia">
                    <?php echo $LinhaPostagem['Conteudo']; ?>
                    <br>
                    <h5 class="legenda" style="text-align: right;">
                        LocalTech, <?php echo date('Y'); ?>
                    </h5>
                </div>
            </div>
        </div>
