...
<head>
    ...
    <title><?php echo $LinhaDados['Nome'] . " " . $LinhaDados['Sobrenome']; ?> - Dashboard Técnico - LocalTech</title>
        ...
        <div class="user-sidebar">
            <div class="user-sidebar-container">
                ...
                <div class="user-sidebar-menu">
                    <ul>
                        <li>
                            <a href="dashboard-tecnico.php" class="user-active">
                    ...
                    <div class="analytics">
                        <div class="analytic">
                            ...
                            <div class="analytic-info">
                                ...
                                <h1>
                                    <?php
                                        require('../../../controller/Resumo/Tecnico/Finalizados.php');
                                    ?>
                                </h1>
                            </div>
                        </div>
                        ...
                        <div class="analytic">
                            ...
                            <div class="analytic-info">
                                ...
                                <h1>
                                    <?php
                                        require('../../../controller/Resumo/Tecnico/Aberto.php');
                                    ?>
                                </h1>
                            </div>
                        </div>
                        ...
                        <div class="analytic">
                            ...
                            <div class="analytic-info">
                                ...
                                <?php
                                    require('../../../controller/Resumo/Tecnico/Ultimo.php');
                                ?>
                            </div>
                        </div>
                            ...
                            <div>
                                <div class="tabela">
                                    <table>
                                        ...
                                        <tbody>
                                            <?php
                                                require('../../../controller/Atendimentos/Tecnico/DadosInicio.php');
                                            ?>
