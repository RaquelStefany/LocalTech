...
<html lang="pt-BR" dir="ltr">
  <head>
    ...
    <title>Serviços - LocalTech</title>
                ...
                <ul class="service-list">
                    <li class="service-container">
                        ...
                        <div class="service-modal flex-center">
                            <div class="service-modal-body" style="margin-top: inherit;" id="teste">
                                <i class="fas fa-times modal-close-btn"></i>
                                <h3>
                                    Assistência Rápida
                                </h3>
                                <h4>
                                    Plano de assistencia para cada dispositivo avaliado remotamente.
                                </h4>
                                <p>
                                    O cliente acessará o chat técnico disponível no sistema, escolhendo um Técnico LocalTech para melhor assim resolver seu problema, ou tirar sua dúvida.
                                </p>
                                <h4>
                                    Detalhes
                                </h4>
                                ...
                                <a href="<?php
                                            ...
                                            if((isset($_SESSION['id_cliente'])) AND (isset($_SESSION['nome_cliente']))){
                                                echo "../PerfilCliente/Chat/tecnicos.php";
                                            }
                                            else if((isset($_SESSION['id_tecnico'])) AND (isset($_SESSION['nome_tecnico']))){
                                                echo "../PerfilTecnico/Chat/clientes.php";
                                            }
                                            else{
                    ...
                    <li class="service-container">
                        ...
                        <div class="service-modal flex-center">
                            <div class="service-modal-body" id="teste">
                                ...
                                <h4>
                                    Plano externo pago diretamente com a Assistência Técnica.
                                </h4>
                                <p>
                                    Plano de divulgação pública de assistência técnica, onde os clientes que necessitam de um profissional técnico especializado e cadastrado na LocalTech.
                                </p>
                                <h4>
                                    Detalhes
                                </h4>
                                ...
                                <a href="../AssistenciasTecnicas/assistencias.php" class="btn" style="float: right;">
