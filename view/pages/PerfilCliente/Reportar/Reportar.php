                        ...
                        <div class="contact-right">
                            ...
                            <form class="contact-form" method="POST">
                                <?php
                                    ...
                                    require_once('../../../../controller/Reportar/Cliente/Reportar.php');
                                ...
                                <div class="second-row">
                                    ...
                                    <select name="tecnico" id="tecnico" style="display: none;">
                                        <option value="" hidden></option>
                                        <?php
                                            require('../../../../controller/Reportar/Cliente/ReportarTecnico.php');
                                        ?>
                                    <select name="assistencia" id="assistencia" style="display: none;">
                                        <option value="" hidden></option>
                                        <?php
                                            require('../../../../controller/Reportar/Cliente/ReportarAssistencia.php');
                                        ?>
                                </div>
                                <div class="third-row">
